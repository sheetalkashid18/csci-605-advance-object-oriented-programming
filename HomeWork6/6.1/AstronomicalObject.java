...
//Astronomical object class for storing all the astronomical objects
public class AstronomicalObject {
	...
	public AstronomicalObject(String string) {
		this.objectName = string;	
	}
	
	//Adds an object of generic type T to a list of all the components in the astronomical object and calculates the average density
	private <T> void add(T AstroObject) {
		this.allComponents.add(AstroObject);
		totalObjectsTillNow++;
	...
	public static void print( AstronomicalObject aStorageOfAstronomicalObject ) {
	...
	public static void testPlanets(){
		    ...
		    //New Object
            AstronomicalObject aStorageOfAstronomicalObject = new AstronomicalObject("Milky Way");
